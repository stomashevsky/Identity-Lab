...
export default function ProofOfAddressVerifiedModal({ isOpen, onClose, enabledFields }: ProofOfAddressVerifiedModalProps) {
  ...
  const allVerificationData = [
    ...
    { key: 'residentialAddress', label: 'Residential Address', value: '123 Main Street, City, Country', enabledKey: 'residentialAddress' },
    { key: 'cardNumber', label: 'Card Number', value: 'P7654321', enabledKey: 'cardNumber' },
