...
export default function HealthInsuranceVerifiedModal({ isOpen, onClose, enabledFields }: HealthInsuranceVerifiedModalProps) {
  ...
  const allVerificationData = [
    ...
    { key: 'cardNumber', label: 'Card Number', value: 'H7654321', enabledKey: 'cardNumber' },
    { key: 'issuingAuthority', label: 'Issuing Authority', value: 'Insurance Fund', enabledKey: 'issuingAuthority' },
    ...
    { key: 'coverageType', label: 'Coverage Type', value: 'Full', enabledKey: 'coverageType' },
      ...
      <div className="flex flex-col gap-4 items-start w-full">
        ...
        <div className="flex flex-col gap-1.5 items-start w-full">
          <h2 className="font-bold leading-tight text-lg text-[#0a0a0a] w-full">
            Health Insurance Card verified
          </h2>
