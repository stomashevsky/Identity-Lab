...
export default function LibraryCardVerifiedModal({ isOpen, onClose, enabledFields }: LibraryCardVerifiedModalProps) {
  ...
  const allVerificationData = [
    ...
    { key: 'cardNumber', label: 'Card Number', value: 'L7654321', enabledKey: 'cardNumber' },
    { key: 'issuingAuthority', label: 'Issuing Authority', value: 'Library', enabledKey: 'issuingAuthority' },
    ...
    { key: 'membershipType', label: 'Membership Type', value: 'Student', enabledKey: 'membershipType' },
