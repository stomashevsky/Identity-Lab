...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col items-start relative w-full">
      ...
      {/* Footer */}
      <div className="flex flex-col gap-6 items-center overflow-hidden px-0 py-12 relative shrink-0 w-full" style={{ backgroundImage: 'linear-gradient(90deg, rgba(255, 255, 255, 0.6) 0%, rgba(255, 255, 255, 0.6) 100%), linear-gradient(90deg, rgba(229, 229, 229, 1) 0%, rgba(229, 229, 229, 1) 100%), linear-gradient(90deg, rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 1) 100%)' }}>
        <div className="flex flex-col gap-16 items-center max-w-[1280px] px-6 py-0 relative shrink-0 w-full">
          <div className="flex items-center justify-between relative shrink-0 w-full">
            <p className="font-normal leading-5 relative shrink-0 text-[#737373] text-sm">
              Copyright 2025 © Folio
            </p>
            <div className="flex gap-8 items-center relative shrink-0">
              <a 
                href="#"
                className="font-normal leading-5 relative shrink-0 text-[#737373] text-sm hover:text-[#0a0a0a] transition-all duration-150 rounded-md px-2 py-1 outline-none focus-visible:outline-none focus-visible:shadow-[0px_0px_0px_3px_rgba(163,163,163,0.5)] cursor-pointer"
              >
                Terms of Service
              </a>
            </div>
